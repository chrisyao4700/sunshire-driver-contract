//
//  TripTextDetailViewController.h
...
@interface TripTextDetailViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,SunshireContractDelegate>
